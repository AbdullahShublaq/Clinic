...
<head>
    ...
    <title>:: Clinic ::</title>
    <link rel="icon" href="{{asset('template/assets/favicon.ico')}}" type="image/x-icon"> <!-- Favicon-->
    <link rel="stylesheet" href="{{asset('template/assets/plugins/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('template/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('template/assets/plugins/morrisjs/morris.min.css')}}"/>
    <!-- Custom Css -->
    ...
    <link href="{{asset('template/assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')}}"
          rel="stylesheet"/>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('template/assets/images/logo.svg')}}" width="48"
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><img src="{{asset('template/assets/images/logo.svg')}}" width="30"
                                                     alt="Oreo"><span class="m-l-10">Clinic</span></a>
            </div>
        </li>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('template/assets/images/xs/avatar2.jpg')}}"
                                         alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('template/assets/images/xs/avatar3.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('template/assets/images/xs/avatar4.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('template/assets/images/xs/avatar5.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{asset('template/assets/images/xs/avatar6.jpg')}}"
                                         alt="">
                                    <div class="media-body">
...
<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dashboard"><i
                        class="zmdi zmdi-home m-r-5"></i>Clinic</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#user"><i
                        class="zmdi zmdi-info m-r-5"></i>My Inf</a></li>
    </ul>
                        ...
                        <div class="user-info">
                            <div class="image"><a href="">
                                    <img style="max-width: 80px; max-height: 80px;"
                                         ...
                                         @else
                                         src="{{url('storage/admins_images/'.session('image'))}}"
                                         @endif
                                         alt="User"></a></div>
                            <div class="detail">
                                <h4>{{ session('user_group_name') }}</h4>
                        ...
                        @if ($section->name == "Dashboard")
                            <li>
                                <a href="{{ url('dashboard') }}"><i
                                            class="{{ $section->icon }}"></i><span>{{ $section->name }}</span></a>
                            </li>
                        @else
                            <li>
                            ...
                            <li>
                                ...
                                <div class="progress m-b-20">
                                    <div class="progress-bar l-green " role="progressbar" aria-valuenow="56"
                                         aria-valuemin="0" aria-valuemax="100" style="width: 56%"><span class="sr-only">87% Complete</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('template/assets/images/xs/avatar1.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('template/assets/images/xs/avatar10.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('template/assets/images/xs/avatar7.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('template/assets/images/xs/avatar8.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('template/assets/images/xs/avatar9.jpg')}}"
                                         alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('template/assets/images/xs/avatar4.jpg')}}"
                                 alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('template/assets/images/xs/avatar5.jpg')}}"
                                 alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('template/assets/images/xs/avatar6.jpg')}}"
                                 alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('template/assets/images/xs/avatar7.jpg')}}"
                                 alt="">
                            <div class="sl-content">
        ...
        <div class="body">
            <div class="chat-widget">
                <ul class="chat-scroll-list clearfix">
                    ...
                    <li class="left float-left"><img src="{{asset('template/assets/images/xs/avatar2.jpg')}}"
                    ...
                    <li class="left float-left"><img src="{{asset('template/assets/images/xs/avatar1.jpg')}}"
                                                     class="rounded-circle"
                                                     alt="">
...
<script src="{{asset('template/light/assets/bundles/morrisscripts.bundle.js')}}"></script><!-- Morris Plugin Js -->
<script src="{{asset('template/light/assets/bundles/jvectormap.bundle.js')}}"></script> <!-- JVectorMap Plugin Js -->
<script src="{{asset('template/light/assets/bundles/knob.bundle.js')}}"></script>
<!-- Jquery Knob, Count To, Sparkline Js -->

<script src="{{asset('template/light/assets/bundles/mainscripts.bundle.js')}}"></script>
<script src="{{asset('template/light/assets/js/pages/index.js')}}"></script>

<script src="{{asset('template/light/assets/js/pages/ui/notifications.js')}}"></script>
...
<script src="{{asset('template/bootstrap-fileinput.js')}}"></script>

<script src="{{asset('template/assets/plugins/sweetalert/sweetalert.min.js')}}"></script> <!-- SweetAlert Plugin Js -->
<script src="{{asset('template/light/assets/js/pages/ui/dialogs.js')}}"></script>


<script src="{{asset('template/assets/plugins/dropzone/dropzone.js')}}"></script> <!-- Dropzone Plugin Js -->
<script src="{{asset('template/assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')}}"></script>

<script src="{{asset('template/costum_input_file.js')}}"></script>
